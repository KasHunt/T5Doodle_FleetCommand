...
using CardinalDirection = Code.Scripts.Utils.T5Utils.CardinalDirection;
...
namespace Code.Scripts
{
    ...
    public class GameboardCanvas : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            foreach (var player in players)
            {
                ...
                if (player == PlayerIndex.One)
                {
                    ...
                    {
                        surfacePivot.transform.rotation = direction.Rotation();
        ...
        {
            var rotation = Quaternion.Inverse(_currentPlayerRotation[playerIndex].Rotation());
        ...
        {
            if (!T5Utils.TryGetPlayerDirection(playerIndex, out var canvasRotation))
            {
                return;
            }
            ...
            _surfaces[playerIndex].transform.rotation = canvasRotation.Rotation();
        }
